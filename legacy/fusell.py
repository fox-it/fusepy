...
class LibFUSE(ctypes.CDLL):
    def __init__(self):
        ...
        self.fuse_mount.argtypes = (ctypes.c_char_p, ctypes.POINTER(fuse_args))

        self.fuse_mount.restype = ctypes.c_void_p

        self.fuse_lowlevel_new.argtypes = (
            ctypes.POINTER(fuse_args),
            ctypes.POINTER(fuse_lowlevel_ops),
            ctypes.c_size_t,
            ctypes.c_void_p,
        )
        ...
        self.fuse_session_add_chan.argtypes = (ctypes.c_void_p, ctypes.c_void_p)
...
class fuse_lowlevel_ops(ctypes.Structure):
    _fields_ = [
        ...
        ("lookup", ctypes.CFUNCTYPE(None, fuse_req_t, fuse_ino_t, ctypes.c_char_p)),
        (
            "forget",
            ctypes.CFUNCTYPE(None, fuse_req_t, fuse_ino_t, ctypes.c_ulong),
        ),  # nlookup is uint64_t in libfuse3
        ...
        (
            "mkdir",
            ctypes.CFUNCTYPE(None, fuse_req_t, fuse_ino_t, ctypes.c_char_p, c_mode_t),
        ),
        ("unlink", ctypes.CFUNCTYPE(None, fuse_req_t, fuse_ino_t, ctypes.c_char_p)),
        ...
        ),  # There is an extra argument `unsigned int flags` in libfuse3
        (
            "link",
            ctypes.CFUNCTYPE(None, fuse_req_t, fuse_ino_t, fuse_ino_t, ctypes.c_char_p),
        ),
        ...
        ("flush", ctypes.CFUNCTYPE(None, fuse_req_t, fuse_ino_t, fuse_file_info_p)),
        ...
        (
            "releasedir",
            ctypes.CFUNCTYPE(None, fuse_req_t, fuse_ino_t, fuse_file_info_p),
        ),
        (
            "fsyncdir",
            ctypes.CFUNCTYPE(None, fuse_req_t, fuse_ino_t, ctypes.c_int, fuse_file_info_p),
        ...
        (
            "removexattr",
            ctypes.CFUNCTYPE(None, fuse_req_t, fuse_ino_t, ctypes.c_char_p),
        ),
        ("access", ctypes.CFUNCTYPE(None, fuse_req_t, fuse_ino_t, ctypes.c_int)),
        (
            "create",
            ctypes.CFUNCTYPE(
                None,
        ...
        (
            "forget_multi",
            ctypes.CFUNCTYPE(None, fuse_req_t, ctypes.c_size_t, fuse_forget_data_p),
        ),
        (
            "flock",
...
class FUSELL(object):
    ...
    def __init__(self, mountpoint, encoding="utf-8"):
        ...
        argv = fuse_args(
            len(args),
            (ctypes.c_char_p * len(args))(*[arg.encode(self.encoding) for arg in args]),
            0,
        )
